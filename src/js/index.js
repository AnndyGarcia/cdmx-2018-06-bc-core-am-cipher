let string = document.getElementsByTagName('input')[0]; // message guarda el valor del texto ingresado por el usuario
let offset = document.getElementsByTagName('input')[1]; // n guarda el numero que se recorre el encriptado
